...
void ProzessComando() {
    ...
    if (data == "mode1"){Serial.println(F("Mode 1 RC"));Mode = 1; domeAutomation = false;}
    if (data == "mode0"){Serial.println(F("Mode 0 Random"));Mode = 0;domeAutomation = true;}
    if (data == "mode3"){Serial.println(F("Mode 3 Service"));Mode = 3;domeAutomation = false;}
    if (data == "mode2"){Serial.println(F("Mode 2 Human"));Mode = 2;domeAutomation = false;}  
